...
$ref = isset($_GET['ref']) ? $_GET['ref'] : 'allcamp'; // Get reference for back button
...
$back_url = ($ref === 'admin') ? 'admin.php' : (($ref === 'user') ? 'my_campaigns.php' : 'campaigns.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="campaign-details-card p-4">
                    ...
                    <div class="text-center mt-4">
                        <a href="<?= $back_url ?>" class="btn btn-secondary me-2">Back</a>
                        <?php if ($campaign['status'] == 'Approved'): ?>
                            <a href="index.php?campaign_id=<?= $campaign_id ?>" class="btn btn-primary">Donate Now</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
